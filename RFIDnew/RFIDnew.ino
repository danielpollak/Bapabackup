...
void loop() {
  delay(500);    Serial.println(digitalRead(7));
...
// This function steps through both newTag and one of the known tags. If there is a mismatch anywhere in the tag, it will return 0, but if every character in the tag is the same, it returns 1
